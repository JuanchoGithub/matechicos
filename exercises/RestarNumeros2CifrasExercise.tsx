...
interface RestarNumeros2CifrasExerciseProps {
...
export const RestarNumeros2CifrasExercise: React.FC<RestarNumeros2CifrasExerciseProps> = ({
  exercise,
  currentAvatar,
  onNavigateBack,
  onGoHome,
  ...
  const verifyAnswer = useCallback(() => {
    ...
    if (userAnswer === currentProblem.correctAnswer) {
      ...
      setFeedback({ type: 'correct', message: '¡Muy bien! Resta correcta.' });
      onComplete(true);
      ...
      setFeedback({ type: 'incorrect', message: 'Respuesta incorrecta. Revisa tu resta e inténtalo de nuevo.' });
      onComplete(false);
    }
  ...
  return (
    <ExerciseScaffold
      ...
      exerciseQuestion={exercise.question || `Resuelve la resta:`}
