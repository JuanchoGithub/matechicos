...
export const Grade3ExercisePage: React.FC<Grade3ExercisePageProps> = ({ gradeId, subjectId, exerciseId, onNavigateBack, onNavigateToMain, onNavigateToAvatar, onSetCompleted }) => {
  ...
  const [exerciseSpecificKeypadHandlerG3, setExerciseSpecificKeypadHandlerG3] = useState<KeypadHandler | null>(null);
  const [customKeypadContentG3, setCustomKeypadContentG3] = useState<React.ReactNode | null>(null); 
  ...
  // State for COMPARAR_MONEDAS_CON_PESO
  ...
  // State for IDENTIFICAR_UNIDAD_MEDIDA_GENERICO
  ...
  useEffect(() => {
    setCustomKeypadContentG3(null); 
    setExerciseSpecificKeypadHandlerG3(null);
  ...
  }, [exerciseId, subjectId, gradeId, exerciseData, generateNewComparisonChallengeG3, generateNewTimeChallengeRelojG3, generateNewCoinCollectionChallengeG3, generateNewUnitChallengeG3]);
  
  const registerKeypadHandlerG3 = useCallback((handler: KeypadHandler | null) => {
    setExerciseSpecificKeypadHandlerG3(() => handler);
  }, []);

  const setSidebarContentForExerciseG3 = useCallback((keypadNode: React.ReactNode | null) => { 
    setCustomKeypadContentG3(keypadNode);
  }, []);
  ...
  const createExerciseContentProps = (api: ExerciseScaffoldApi) => ({
    ...
    registerKeypadHandler: registerKeypadHandlerG3,
    setCustomKeypadContent: setSidebarContentForExerciseG3,
    gradeLevel: gradeId, 
  });
  
  let mainContentRenderer: (api: ExerciseScaffoldApi) => React.ReactNode;
  let keypadToRenderG3: React.ReactNode = null; 
  let allowDecimalForKeypadG3 = false;
  ...
  switch (exerciseData.componentType) {
    ...
    case ExerciseComponentType.IDENTIFICAR_ORDINALES: mainContentRenderer = (api) => <IdentificarOrdinalesExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break; 
    ...
    case ExerciseComponentType.LEER_FRACCIONES_PROPIAS: mainContentRenderer = (api) => <LeerFraccionesPropiasExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.REPRESENTAR_FRACCIONES: mainContentRenderer = (api) => <RepresentarFraccionesExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break;
    ...
    // Problemas
    case ExerciseComponentType.PROBLEMAS_PASO_A_PASO: mainContentRenderer = (api) => <ProblemasMatematicosGuiadosExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break; 
    ...
    case ExerciseComponentType.LEER_RELOJ_OPCIONES: mainContentRenderer = () => (<LeerRelojOpcionesExercise hours={currentTimeChallengeRelojG3?.hours ?? 0} minutes={currentTimeChallengeRelojG3?.minutes ?? 0} currentEmoji={relojEmojiG3} questionText={exerciseData.question || "¿Qué hora es?"}/>); keypadToRenderG3 = (<TimeOptionsKeypad options={currentTimeChallengeRelojG3?.options || []} selectedOption={selectedTimeOptionRelojG3} onOptionSelect={handleTimeOptionSelectRelojG3} onVerify={handleVerifyTimeAnswerRelojG3} isVerified={isVerifiedRelojG3} correctAnswerText={currentTimeChallengeRelojG3?.correctText || null}/>); break;
    ...
    case ExerciseComponentType.SUMAR_MONEDAS_PESOS_CENTAVOS: mainContentRenderer = (api) => <SumarMonedasPesosCentavosExercise {...createExerciseContentProps(api)} />; allowDecimalForKeypadG3 = true; break;
    // Geometria
    case ExerciseComponentType.IDENTIFICAR_FORMA_GEOMETRICA_GENERICO: mainContentRenderer = (api) => <IdentificarFormaGeometricaGenericoExercise {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.IDENTIFICAR_PARTES_CIRCULO: mainContentRenderer = (api) => <IdentificarPartesCirculoExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.CALCULAR_PERIMETRO_POLIGONO_SIMPLE: mainContentRenderer = (api) => <CalcularPerimetroPoligonoSimpleExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} registerKeypadHandler={registerKeypadHandlerG3} />; break; 
    // Estadistica
    case ExerciseComponentType.TEST_INTERPRETAR_DIAGRAMAS_BARRAS: case ExerciseComponentType.INTERPRETAR_DIAGRAMA_BARRAS_VERTICAL: case ExerciseComponentType.INTERPRETAR_DIAGRAMA_BARRAS_HORIZONTAL: mainContentRenderer = (api) => <TestInterpretarDiagramasBarras {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.INTERPRETAR_TABLA_SIMPLE: mainContentRenderer = (api) => <InterpretarTablaSimpleExercise {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3} />; break; 
    case ExerciseComponentType.UBICAR_EN_TABLA: mainContentRenderer = (api) => <UbicarEnTablaExercise {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3}/>; break;
    case ExerciseComponentType.INTERPRETAR_TABLA_DOBLE_ENTRADA: mainContentRenderer = (api) => <InterpretarTablaDobleEntradaExercise {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3}/>; break;
    ...
    case ExerciseComponentType.ORDENAR_DATOS_EN_TABLA: mainContentRenderer = (api) => <OrdenarDatosEnTablaExercise {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.COMPARAR_TABLAS_SIMPLES: mainContentRenderer = (api) => <CompararTablasSimplesExercise {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.INTERPRETAR_DIAGRAMA_LINEAL_SIMPLE: mainContentRenderer = (api) => <InterpretarDiagramaLinealSimpleExercise {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.INTERPRETAR_DIAGRAMA_DOS_LINEAS: mainContentRenderer = (api) => <InterpretarDiagramaDosLineasExercise {...createExerciseContentProps(api)} setExternalKeypad={setSidebarContentForExerciseG3} />; break;
    // Probabilidad
    case ExerciseComponentType.CERTEZA_SUCESOS: mainContentRenderer = (api) => <CertezaSucesosExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.COMPARAR_PROBABILIDADES: mainContentRenderer = (api) => <CompararProbabilidadesExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.EXPRESAR_PROBABILIDAD_SIMPLE: mainContentRenderer = (api) => <ExpresarProbabilidadSimpleExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break;
    case ExerciseComponentType.FRECUENCIA_SUCESOS: mainContentRenderer = (api) => <FrecuenciaSucesosExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setSidebarContentForExerciseG3} />; break;
    
    case ExerciseComponentType.GENERIC: default: mainContentRenderer = (api) => <GenericExerciseDisplay exerciseData={exerciseData} gradeThemeColor={gradeThemeColor} onNavigateBack={onNavigateBack} onNavigateToAvatar={onNavigateToAvatar} currentAvatar={currentAvatar} />; keypadToRenderG3 = null; break;
  }
  
  let finalKeypadComponentForScaffold: React.ReactNode = customKeypadContentG3; 
  if (!finalKeypadComponentForScaffold) { 
    if (keypadToRenderG3) { 
        finalKeypadComponentForScaffold = keypadToRenderG3;
    } else if (exerciseSpecificKeypadHandlerG3) { 
        finalKeypadComponentForScaffold = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandlerG3} className="w-full" allowDecimal={allowDecimalForKeypadG3} />;
    } else {
