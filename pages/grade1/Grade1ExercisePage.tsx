...
import { GradeLevel, SubjectId, Exercise, ExerciseComponentType, AvatarData, ExerciseScaffoldApi, TimeChallengeData, Coin, ComparisonSymbol } from '../../types'; // Added Coin, ComparisonSymbol
...
export const Grade1ExercisePage: React.FC<Grade1ExercisePageProps> = ({ gradeId, subjectId, exerciseId, onNavigateBack, onNavigateToMain, onNavigateToAvatar, onSetCompleted }) => {
  ...
  }, [exerciseId, exerciseData, generateNewComparisonChallengeG1, generateNewTimeChallengeRelojG1, generateNewCoinCollectionChallengeG1]);
  ...
  const setCustomKeypadContentG1 = useCallback((keypadNode: React.ReactNode | null) => { 
  ...
  const createExerciseContentProps = (api: ExerciseScaffoldApi) => ({
    ...
    setCustomKeypadContent: setCustomKeypadContentG1, 
  ...
  switch (exerciseData.componentType) {
    case ExerciseComponentType.CONTAR_ELEMENTOS: mainContentRenderer = (api) => <ContarElementosExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.IDENTIFICAR_PARES_IMPARES: mainContentRenderer = (api) => <IdentificarParesImparesExercise {...createExerciseContentProps(api)}/>; break;
    ...
    case ExerciseComponentType.NUMERO_ANTERIOR_POSTERIOR: mainContentRenderer = (api) => <NumeroAnteriorPosteriorExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.ESCRIBIR_HASTA_10000: mainContentRenderer = (api) => <EscribirHasta10000Exercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.COMPARAR_HASTA_10000: mainContentRenderer = () => ( <CompararHasta10000Exercise number1={comparisonChallengeG1?.number1 ?? null} number2={comparisonChallengeG1?.number2 ?? null} selectedSymbol={comparisonSelectedSymbolG1} currentEmoji={comparisonEmojiG1} questionText={exerciseData.question || "¿Cuál es el símbolo correcto?"}/>); keypadToRender = (<ComparisonKeypad onSymbolSelect={handleComparisonSymbolSelectG1} onVerify={handleComparisonVerifyAnswerG1} selectedSymbol={comparisonSelectedSymbolG1} isVerified={comparisonIsVerifiedG1} correctSymbolForFeedback={comparisonChallengeG1?.correctSymbol ?? null} />); break;
    case ExerciseComponentType.COMPONER_HASTA_10000_ABACO: mainContentRenderer = (api) => <ComponerHasta10000AbacoExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break; 
    case ExerciseComponentType.COMPONER_HASTA_10000_TEXTO: mainContentRenderer = (api) => <ComponerHasta10000TextoExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    ...
    case ExerciseComponentType.ARITMETICA_SIMPLE_2_CIFRAS: mainContentRenderer = (api) => <TwoDigitSimpleArithmeticExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.CALCULA_MENTALMENTE: mainContentRenderer = (api) => <CalculaMentalmenteExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.VISUAL_ARITHMETIC_1_DIGIT: mainContentRenderer = (api) => <VisualArithmetic1DigitExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.COLUMNAR_OPERATION: mainContentRenderer = (api) => <ColumnarOperationExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    
    case ExerciseComponentType.PROBLEMAS_PASO_A_PASO: 
      mainContentRenderer = (api) => <ProblemasMatematicosGuiadosExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; 
      break;

    case ExerciseComponentType.COMPARAR_ALTURAS: mainContentRenderer = (api) => <CompararAlturasExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.COMPARAR_LONGITUDES: mainContentRenderer = (api) => <CompararLongitudesExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.MEDIR_CON_REGLA_CM: mainContentRenderer = (api) => <MedirConReglaCmExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.COMPARAR_PESOS_CONCEPTUAL: mainContentRenderer = (api) => <CompararPesosConceptualExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.BALANZA_1KG: mainContentRenderer = (api) => <Balanza1KgExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.COMPARAR_CAPACIDAD_1L: mainContentRenderer = (api) => <CompararCapacidad1LitroExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.PROBLEMAS_CAPACIDAD_SUMA_RESTA: mainContentRenderer = (api) => <ProblemasCapacidadSumaRestaExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.SUMAR_ITEMS_MONETARIOS_SIMPLES: case ExerciseComponentType.SUMAR_MONEDAS_PESOS_SIMPLES: case ExerciseComponentType.SUMAR_BILLETES_PESOS: mainContentRenderer = (api) => <SumarItemsMonetariosSimplesExercise {...createExerciseContentProps(api)} />; keypadToRender = <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler || (() => {})} className="w-full" />; break;
    case ExerciseComponentType.COMPARAR_MONEDAS_CON_PESO: mainContentRenderer = () => ( <CompararMonedasConPesoExercise coinsToDisplay={coinCollectionChallengeG1?.coins || []} currentEmoji={monetaryComparisonEmojiG1} questionText={exerciseData.question || "¿El valor total es?"}/>); keypadToRender = (<MonetaryComparisonKeypad onOptionSelect={handleMonetaryComparisonOptionSelectG1} onVerify={handleVerifyMonetaryComparisonAnswerG1} selectedOption={selectedMonetaryComparisonOptionG1} isVerified={isMonetaryComparisonVerifiedG1} correctOptionForFeedback={coinCollectionChallengeG1?.correctOption ?? null} targetAmountLabel="$1"/>); break;
    case ExerciseComponentType.CALENDARIO_MES_ANT_POST: mainContentRenderer = (api) => <CalendarioMesAnteriorPosteriorExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.LEER_RELOJ_OPCIONES: mainContentRenderer = () => (<LeerRelojOpcionesExercise hours={currentTimeChallengeRelojG1?.hours ?? 0} minutes={currentTimeChallengeRelojG1?.minutes ?? 0} currentEmoji={relojEmojiG1} questionText={exerciseData.question || "¿Qué hora es?"}/>); keypadToRender = (<TimeOptionsKeypad options={currentTimeChallengeRelojG1?.options || []} selectedOption={selectedTimeOptionRelojG1} onOptionSelect={handleTimeOptionSelectRelojG1} onVerify={handleVerifyTimeAnswerRelojG1} isVerified={isVerifiedRelojG1} correctAnswerText={currentTimeChallengeRelojG1?.correctText || null}/>); break;
    case ExerciseComponentType.COMPLETAR_PALABRA_SIMPLE: mainContentRenderer = (api) => <CompletarPalabraSimpleExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.SECUENCIA_DIA_SEMANA: mainContentRenderer = (api) => <SecuenciaDiaSemanaExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.SECUENCIA_MES_ANIO: mainContentRenderer = (api) => <SecuenciaMesAnioExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.POSICION_RELATIVA_OBJETOS: mainContentRenderer = (api) => <PosicionRelativaObjetosExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.IDENTIFICAR_FORMA_GEOMETRICA_GENERICO: mainContentRenderer = (api) => <IdentificarFormaGeometricaGenericoExercise {...createExerciseContentProps(api)} setExternalKeypad={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.INTERPRETAR_PICTOGRAMAS: mainContentRenderer = (api) => <InterpretarPictogramasExercise {...createExerciseContentProps(api)} />; keypadToRender = exerciseSpecificKeypadHandler ? <NumericKeypad onKeyPress={exerciseSpecificKeypadHandler} className="w-full" /> : null; break;
    case ExerciseComponentType.CERTEZA_SUCESOS: mainContentRenderer = (api) => <CertezaSucesosExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
    case ExerciseComponentType.FRECUENCIA_SUCESOS: mainContentRenderer = (api) => <FrecuenciaSucesosExercise {...createExerciseContentProps(api)} setCustomKeypadContent={setCustomKeypadContentG1} />; break;
  ...
  let finalKeypadComponentForScaffold: React.ReactNode = customKeypadContent; 
